...
<?php
  ...
  $search = $_GET['q'];
    $data = 
      ...
      FILTER (regex (?namaDokter,  '$search', 'i'))
        }
      ORDER BY ?dokterSpesialis
...
<html>
  ...
  ?>
<h1 style="text-align:center">Jadwal Praktek <?= $data->namaDokter?></h1>
  <div>
  <table class="table text-center" style="width: 80%; margin-left:10%">
                            <tr>
                                <th>Nama Dokter</th>
                                <th>Spesialis</th>
                                <th>Umur</th>
